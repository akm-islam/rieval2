 ...
 */
export var ARCHOR = ["nw", "n", "ne", "e", "se", "s", "sw", "w"];
/**
 * 操作类型
 *  - ROTATE = "rotate",
 *  - RESIZE = "resize",
...
export var EMPTY_POINT = {
  x: 0,
  y: 0
};
export var EMPTY_RECT = {
  x: 0,
  y: 0,
  width: 0,
  height: 0,
...
var PRECISION = 1e-5;
export var symmetryPoint = function symmetryPoint(start, center) {
...
export var getMousePoint = function getMousePoint(e) {
  return {
    x: e.pageX,
    y: e.pageY
  };
...
export var rectCenter = function rectCenter(rect) {
  var x = rect.x,
      y = rect.y,
      width = rect.width,
      height = rect.height;
...
export var angleDegrees = function angleDegrees(point) {
  var x = point.x,
      y = point.y;
...
export var rotatePositionRelatively = function rotatePositionRelatively(position, relative, angle) {
  var shiftPosition = {
...
export var rotatePosition = function rotatePosition(position, angle) {
...
export var centerPoint = function centerPoint(pa, pb) {
  return {
    x: (pa.x + pb.x) / 2,
    y: (pa.y + pb.y) / 2
  };
...
export var computeRectWithCrossPoints = function computeRectWithCrossPoints(pa, pb, angle) {
...
export var squareCrossPoint = function squareCrossPoint(points, point) {
  var x = point.x,
      y = point.y;
...
export var pointsDistance = function pointsDistance(p0, p1) {
  var x = p0.x - p1.x;
  var y = p0.y - p1.y;
...
export var moveRect = function moveRect(mouseStart, mouseEnd, rectStart) {
...
export var lineSlope = function lineSlope(p0, p1) {
...
export var lineDegrees = function lineDegrees(p0, p1) {
  if (roughlyEqual(p0.x, p1.x)) {
    return 0;
  }
...
export var computeRotation = function computeRotation(center, start, end) {
  var shiftStart = {
    x: start.x - center.x,
    y: start.y - center.y
  };
...
export var rotateRect = function rotateRect(mouseStart, mouseEnd, rectStart) {
...
export var computeRatioedRectWithPinnedLine = function computeRatioedRectWithPinnedLine(pinnedPoints, dragPoint, rectStart, activeExpand) {
...
export var computeRectWithPinnedLine = function computeRectWithPinnedLine(pinnedPoints, dragPoint, angle) {
...
export var resizeRect = function resizeRect(mouseStart, mouseEnd, adjustType, rectStart, fixedRatio) {
...
export default (function (adjustType, mouseStart, mouseEnd, rectStart) {
