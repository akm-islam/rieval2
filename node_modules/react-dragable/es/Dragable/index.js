...
import { EMPTY_POINT, EMPTY_RECT, getMousePoint, default as rotateResizeRect, Actions, ARCHOR } from "../utils/rotateResize";
...
function (_Component) {
  ...
  _createClass(Dragable, [{
    ...
    value: function render() {
      ...
      }, React.isValidElement(children) ? children : children(rect), ARCHOR.map(function (direct) {
        return React.createElement("i", {
          key: direct,
          className: cls("archor", "archor-".concat(direct)),
          style: {
      ...
      }), React.createElement(RotateArrow, {
        onMouseDown: function onMouseDown(e) {
