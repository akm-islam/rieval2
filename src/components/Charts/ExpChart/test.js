        ...
        enter => enter.append('circle')
            ...
            .attr("transform", function (d, i) {
                ...
                if(clicked_circles.includes(d['id'])){
                    selection.selectAll(".label"+d['id']).data([0]).join("text").attr("x", x_transform).attr("class", "label"+d['id']).attr('dominant-baseline',"middle").attr("y",y_transform+13).text(d["two_realRank"]).attr("font-size",10)
                }
                else{
