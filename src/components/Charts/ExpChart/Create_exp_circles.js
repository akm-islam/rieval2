...
export default function CreatexpCircle(d, selection, selected_instances,
    ...
    var rScale = d3.scalePow().exponent(0.4).domain(d3.extent(deviation_array)).range([state.global_config.max_circle_r, state.global_config.min_circle_r]) // Older .exponent(0.2)
