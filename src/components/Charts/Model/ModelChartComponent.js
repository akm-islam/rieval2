...
class SlopeChart extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    var d = (max - min) / 8;
    var diverginColor = d3.scaleLinear().domain([max + d * 7, min + d * 6, min + d * 5, min + d * 4, min + d * 3, min + d * 2, min]).interpolate(d3.interpolateRgb).range(['#af8dc3','#b197c1','#dbd88c','#dbd88c', '#dbd88c', '#90bc8d', '#7fbf7b']);
